...
while [ $j -gt $k ]; do
    ...
    hadoop jar /work/recommender/remd-hadoop-1.0-SNAPSHOT-jar-with-dependencies.jar RecommendCleaner /recommender/tmp/recommender.log.$yesterday /recommender/data/history/ /recommender/result_temp/${stat_date}/ /recommender/result/${stat_date}/
    #将结果覆盖下history目录
    ...
    hadoop jar /work/recommender/remd-hadoop-1.0-SNAPSHOT-jar-with-dependencies.jar RecommendCleaner /recommender/tmp/recommender.log.$stat_date /recommender/data/history/ /recommender/result_temp/${stat_date}/ /recommender/result/${stat_date}/
    fi
    #执行mahout计算结果
