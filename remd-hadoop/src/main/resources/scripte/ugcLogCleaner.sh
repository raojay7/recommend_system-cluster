...
#input /source/ugctail/20180113/* #output /result/ugctail/20180113/*
#crontab 设置
# 凌晨 0:11
#
i=1
...
while [ $i -gt $j ]; do
    ...
    echo "hadoop jar /work/recommender/remd-hadoop-1.0-SNAPSHOT-jar-with-dependencies.jar UgcLogCleaner /source/ugctail/Tail.log.$stat_date /result/ugctail/${stat_date}/"
